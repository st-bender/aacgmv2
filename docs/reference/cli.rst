...
When you install this package you will get a command called ``aacgm2``. It has two subcommands, ``convert`` and ``convert_mlt``, which correspond to the functions :py:func:`aacgm2.convert` and :py:func:`aacgm2.convert_mlt`. See the documentation for these functions for a more thorough explanation of arguments and behaviour.
