...
setup(
    ...
    author='Stefan Bender, Angeline G. Burrell, Christer van der Meeren',
    author_email='stefan.bender@ntnu.no',
    url='https://github.com/st-bender/aacgmv2',
    packages=find_packages('src'),
    package_dir={'': 'src'},
    py_modules=[splitext(basename(path))[0] for path in glob('src/*.py')],
    package_data={'pyaacgmv2': ['aacgm_coeffs/*.asc', 'igrf12coeffs.txt']},
    zip_safe=False,
    classifiers=[
    ...
    ext_modules=[
        Extension('pyaacgmv2._aacgmv2',
                  sources=['src/pyaacgmv2/aacgmv2module.c',
    ...
    entry_points={
        'console_scripts': [
            'pyaacgmv2 = pyaacgmv2.__main__:main',
        ]
    },
)
